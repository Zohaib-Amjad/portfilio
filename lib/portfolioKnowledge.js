...
const portfolioKnowledge = {
  ...
  phone: '+92 316 4232384 / +92 302 9629511',
  ...
  experience: [
    ...
    },
    {
      ...
      highlights: [
        'Progressed from intern to WordPress Developer on production client sites.',
        'Built pixel-perfect WordPress sites with Elementor.',
        'Converted Figma designs into responsive WordPress pages.',
        'Strengthened JavaScript and learned React.js for modern web apps.',
      ],
    },
    {
  ...
  projects: [
    {
      title: 'HOF Global',
      description:
        'Company website for HOF Global covering IT solutions, BPO, and tech recruitment. Built during the full-stack internship.',
    ...
    },
    {
      ...
      description:
        'Animated Next.js portfolio with contact API routes and Supabase persistence.',
...
export { portfolioKnowledge, buildKnowledgePrompt }
