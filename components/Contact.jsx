        ...
        <div className="grid gap-10 lg:grid-cols-[.7fr_1.3fr]">
          ...
          >
            ...
            <div className="mt-8 space-y-4">
              ...
              />
              <PhoneChooser phones={(profile.phones || [profile.phone]).filter(Boolean)} />
          ...
          >
            ...
            {RECAPTCHA_SITE_KEY ? (
              ...
              <p className="font-mono text-[10px] text-faint sm:col-span-2">
                Set `NEXT_PUBLIC_RECAPTCHA_SITE_KEY` to enable reCAPTCHA in production.
              </p>
            )}
  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className="flex w-full items-center gap-3 font-mono text-xs text-heading transition-colors hover:text-accent"
      >
        <span className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-accent/10 text-accent">
          <Phone size={18} />
        </span>
        <span className="flex-1 text-left">Phone — choose a number</span>
        <ChevronDown
          size={14}
      ...
      <AnimatePresence>
        {open && (
          <motion.ul
            ...
            className="absolute left-0 right-0 z-20 mt-2 overflow-hidden rounded-xl border border-line bg-panel shadow-[0_12px_40px_rgba(0,0,0,0.45)]"
          >
            {phones.map((phone, index) => (
              <li key={phone} role="option">
                <a
                  ...
                  className="flex items-center gap-3 border-b border-line/70 px-4 py-3 font-mono text-xs text-heading transition-colors last:border-b-0 hover:bg-accent/10 hover:text-accent"
                >
